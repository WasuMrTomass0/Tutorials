...
def etap1(z):
    ...
    # Dodaj 10 pierwszych Creepereow
    for i in range(10):
...
def etap2(z):
    ...
    # Wykonaj 11 razy kod zawarty wewnątrz wcięcia
    for i in range(20):
        # Spawnuj zombie w losowy miejscu (ale wewnatrz naszego etapu)
...
while True:  
    ...
    if blocks.test_for_block(SEA_LANTERN, pos(0, -1, 0)):
        ...
        etap2(z)
        # Po wykonaniu funkcji "etap2" zatrzymujemy nasz program na 0,5 sekundy (500 milisekund)
        loops.pause(500)
